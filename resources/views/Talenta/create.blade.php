        ...
        <div class="col-md-4">
            <div class="card" style="border:3px solid #084595">
                ...
                <div class="card-body bgdark">
                    <form action="{{ route('talentas.store') }}" method="post">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="@error('talent') is-invalid @enderror form-control" id="talent"
                                name="talent" placeholder="Tuliskan talent anda ">
                            @error('talent')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="@error('marque') is-invalid @enderror form-control" id="marque" name="marque"
                                placeholder="Tuliskan quotes anda "></textarea>
                            @error('marque')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>

                        <button type="submit" class="btn bg-bdark text-light mb-3"><b>Tambah</b></button>
                    </form>
                </div>
            </div>
        </div>
